		...
		const queryParamNodes: BinaryNode[] = [
			{
				tag: "limit",
				attrs: {},
				content: utf8StringToUint8Array((limit || 10).toString()),
			},
			{
				tag: "width",
				attrs: {},
				content: utf8StringToUint8Array("100"),
			},
			{
				tag: "height",
				attrs: {},
					...
					content: [
						{
							...
							attrs: {},
							content: utf8StringToUint8Array(limit.toString()),
						},
						{
							tag: "item_limit",
							attrs: {},
			...
			content: [
				{
					...
					content: [
						...
						},
						{
							tag: "token",
							attrs: {},
							content: utf8StringToUint8Array(tokenBase64),
						},
					],
				},
			],
						...
						content: [
							{
								tag: "id",
								attrs: {},
								content: utf8StringToUint8Array(id),
							},
						],
					})),
				},
