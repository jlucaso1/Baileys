...
type ProcessMessageContext = {
	...
	logger?: Logger;
	// biome-ignore lint/complexity/noBannedTypes: type later
	...
	if (protocolMsg) {
		switch (protocolMsg.type) {
			...
			case proto.MessageProtocolMessageType.EPHEMERAL_SETTING:
				...
				break;
			case proto.MessageProtocolMessageType
				...
				if (response) {
					...
					for (const result of peerDataOperationResult!) {
						...
						if (retryResponse?.webMessageInfoBytes) {
							const webMessageInfo = readBinaryNode(
								proto.readWebMessageInfo,
							...
							pollUpdates: [
								{
									...
									vote: voteMsg,
									senderTimestampMs:
										content.pollUpdateMessage.senderTimestampMs,
								},
							],
						},
					},
