...
import { WAProto as proto } from "../";
import type { DownloadableMessage, MediaType } from "../Types";
import { downloadContentFromMessage } from "../Utils";
import { readBinaryNode } from "../Utils/proto-utils";
...
const TEST_VECTORS: TestVector[] = [
	{
		type: "image",
		message: readBinaryNode(
			proto.readMessageImageMessage,
			Buffer.from(
...
describe.skip("Media Download Tests", () => {
