...
import type { MEDIA_HKDF_KEY_MAPPING } from "../Defaults";
...
export type WAGenericMediaMessage =
	| proto.MessageVideoMessage
	| proto.MessageImageMessage
	| proto.MessageAudioMessage
	| proto.MessageDocumentMessage
	| proto.MessageStickerMessage;
...
export type WASendableProduct = Omit<
	proto.MessageProductMessageProductSnapshot,
	"productImage"
> & {
